    ...
    >
      ...
      {children && (
        <foreignObject
          ...
          clipPath="url(#roundedCorners)"
        >
          <div style={{ width: '100%', height: '100%', borderRadius: '24.62px', overflow: 'hidden', position: 'relative' }}>
            {children}
          </div>
        </foreignObject>
      )}
