...
const stats = [
  ...
  },
  {
    ...
    context: 'Less than 5 minutes on average for approval',
  },
];
          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="text-[9px] font-bold text-[#E2A816] bg-[rgba(226,168,22,0.08)] px-2.5 py-1 rounded-full tracking-wider uppercase">
                  ILLUSTRATIVE DATA
                </span>
              </div>
              ...
              <div className="px-6 py-5">
                {/* Column Headers */}
                <div
                  className="grid grid-cols-3 text-[10px] font-bold text-[#6B7799] uppercase tracking-[0.12em] pb-3 mb-3"
                  style={{ borderBottom: '1px solid #E8EEFF' }}
                >
                  <span>Claim ID</span>
                  <span>Countdown</span>
                ...
                <div className="flex flex-col gap-0">
                  {[
                    ...
                    <div
                      ...
                      style={{
                        borderBottom:
                          i < 3 ? '1px solid rgba(232,238,255,0.5)' : 'none',
                      }}
                    >
          ...
          <div className="flex flex-col gap-0 pt-4">
            {stats.map((stat, i) => (
              <motion.div
                ...
                className={`py-8 ${
                  i !== stats.length - 1 ? 'border-b border-[#E8EEFF]' : ''
                }`}
              >
