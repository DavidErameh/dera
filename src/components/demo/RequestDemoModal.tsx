          ...
          >
            <div className="relative bg-white rounded-2xl shadow-lg p-4 sm:p-6 md:p-6 lg:p-8">
              ...
              <div className="flex flex-col md:flex-row items-stretch gap-4 md:gap-6">
                {/* Blue card - hidden on mobile, visible on md+ */}
                <div className="hidden md:flex w-[55%] min-h-[70vh] lg:min-h-[750px] bg-gradient-to-br from-[#8BB4FF] via-[#6BA3FF] to-white rounded-2xl shadow-md flex-col items-center justify-center p-6 lg:p-8 text-center">
                  <h2
                    className="text-white/90 text-3xl md:text-5xl lg:text-6xl font-semibold -mb-4 md:-mb-6"
                  ...
                  <img
                    ...
                    alt="DERA"
                    className="w-32 md:w-44 lg:w-56 h-auto -mt-4 md:-mt-6"
                ...
                <div className="flex-1 w-full p-0 md:p-4">
                  ...
                  {/* Desktop header - only show on md+ */}
                  <div className="hidden md:block mb-6 lg:mb-8">
                    <h3
                      className="text-2xl md:text-3xl lg:text-4xl font-semibold text-[#0A1628] mb-2 md:mb-3"
                      style={{ fontFamily: "var(--font-garamond)" }}
                    >
                      Request a Demo
                    </h3>
                    <p className="text-sm md:text-base text-[#6B7799] max-w-lg leading-relaxed">
                      See how Dera can streamline your claims process. Our team
                      will reach out within 2 business days to schedule your
                      personalized demo.
                    </p>
                  </div>
